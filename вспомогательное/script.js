...
const QUIZZES = {
  famous: {
    ...
    questions: [
      ...
      { q: 'Какая белорусская княгиня прославилась тем, что лично возглавила оборону Слуцка от крымских татар в XVI веке?',
        id: '1.11',
        opts: ['Рогнеда Полоцкая','Анастасия Слуцкая','София Гольшанская','Ефросиния Полоцкая'], ans: 1,
  ...
  history: {
    ...
    questions: [
      ...
      { q: 'Какую главную святыню заказала Ефросиния Полоцкая у мастера Лазаря Богши в 1161 году?',
        id: '2.17',
